...
const STRUCTURED_ROADMAPS: Record<
	string,
	Omit<RoadmapPhase, "status" | "order">[]
> = {
	"AI / Machine Learning Engineer": [
		{
			id: "phase-1",
			label: "Math & Python Foundations",
			duration: "3 weeks",
			description:
				"Build the mathematical and programming foundation required for all ML work.",
			skills: ["Linear Algebra", "Statistics", "NumPy", "Pandas", "Python OOP"],
			milestones: [
				"Implement matrix operations from scratch",
				"Complete a statistics project with NumPy/Pandas",
				"Write unit tests for your data processing pipeline",
			],
			resources: [
				{
				...
				{
					label: "NumPy Official Guide",
					url: "https://numpy.org/doc/stable/user/absolute_beginners.html",
				},
				{
					label: "Pandas Documentation – Getting Started",
					url: "https://pandas.pydata.org/docs/getting_started/index.html",
				},
				{
					label: "MIT OCW – Linear Algebra",
					url: "https://ocw.mit.edu/courses/18-06sc-linear-algebra-fall-2011/",
				},
				{
					label: "Real Python – Python OOP",
					url: "https://realpython.com/python3-object-oriented-programming/",
				},
				{
					label: "DataCamp – Intro to Python",
		...
		},
		{
			...
			milestones: [
				"Train and evaluate 3 models on a real dataset",
				"Achieve 80%+ accuracy on a Kaggle beginner competition",
				"Create a model comparison notebook with cross-validation",
			],
			resources: [
				{
					label: "Hands-On ML with Scikit-Learn",
					url: "https://www.oreilly.com/library/view/hands-on-machine-learning/9781492032632/",
				},
				{
					label: "StatQuest – ML Fundamentals",
					url: "https://www.youtube.com/@statquest",
				},
				{
					label: "Scikit-learn Official Tutorials",
					url: "https://scikit-learn.org/stable/tutorial/index.html",
				},
				{
					label: "Kaggle – Intro to Machine Learning",
				...
				{
					label: "Towards Data Science – ML Articles",
					url: "https://towardsdatascience.com/",
				},
				{
					label: "Analytics Vidhya – ML Guide",
					url: "https://www.analyticsvidhya.com/blog/2021/01/5-free-courses-to-learn-machine-learning/",
				},
				{
				...
				{
					label: "Coursera – ML Specialization (Andrew Ng)",
		...
		},
		{
			...
			duration: "5 weeks",
			description:
				"Understand neural networks and build deep learning models with PyTorch.",
			skills: [
				"PyTorch",
				"CNNs",
				"RNNs",
			...
			milestones: [
				"Train a CNN on CIFAR-10 with >85% accuracy",
		...
		},
		{
			...
			duration: "4 weeks",
			description: "Master transformer architecture and large language models.",
			skills: [
				"Tokenization",
				"Attention Mechanism",
				"HuggingFace",
			...
			milestones: [
				...
				"Deploy a model behind a Gradio interface",
			],
			resources: [
				{
					label: "HuggingFace NLP Course",
				...
				{
					label: "Weaviate – Vector Search Guide",
				...
				{
					label: "HuggingFace Transformers Docs",
					url: "https://huggingface.co/docs/transformers/index",
				},
				{
					label: "LLM University by Cohere",
		...
		},
		{
			...
			duration: "3 weeks",
			description: "Ship models to production with monitoring and CI/CD.",
			skills: ["FastAPI", "Docker", "MLflow", "Model Serving", "CI/CD"],
			milestones: [
				"Deploy a model as a REST API",
				"Set up experiment tracking with MLflow",
				"Containerize your ML app with Docker",
			],
			resources: [
				{
				...
				{
					label: "Neptune.ai – MLOps Guide",
					url: "https://neptune.ai/blog/mlops",
				},
				{
					label: "GitHub Actions CI/CD Docs",
		...
		},
		{
			...
			duration: "4 weeks",
			description:
				"Build an end-to-end ML project demonstrating all acquired skills.",
			skills: [
				"Problem Scoping",
				"Data Collection",
				"Model Training",
			...
			milestones: [
				"Ship a complete ML project on GitHub",
				"Write a detailed README with results and architecture",
				"Present your project with a live demo video",
			],
			resources: [
				{
				...
				{
					label: "Awesome ML Projects on GitHub",
					url: "https://github.com/maelfabien/Machine-Learning",
				},
				{
	...
	"Frontend Engineer": [
		{
			id: "phase-1",
			label: "HTML & CSS Mastery",
			duration: "2 weeks",
			description: "Build pixel-perfect, responsive layouts with modern CSS.",
			skills: [
				"Semantic HTML5",
				"CSS Grid",
				"Flexbox",
			...
			milestones: [
				"Clone 3 real website layouts from scratch",
				"Build a fully responsive portfolio page",
				"Create an animated landing page with CSS transitions",
			],
			resources: [
				{
				...
				{
					label: "Kevin Powell – CSS YouTube",
		...
		},
		{
			...
			duration: "3 weeks",
			description:
				"Master JavaScript fundamentals, async patterns, and modern ES6+ features.",
			skills: [
				"Closures & Scope",
				"Async/Await",
				"Promises",
			...
			milestones: [
				"Build a weather app with fetch API",
				"Implement a promise-based task queue",
				"Create a vanilla JS SPA with routing",
			],
			resources: [
				{ label: "javascript.info", url: "https://javascript.info" },
				{
					label: "You Don't Know JS (Free Book)",
		...
		},
		{
			...
			duration: "4 weeks",
			description:
				"Build component-driven UIs with type safety and modern React patterns.",
			skills: [
				"JSX",
				"Hooks",
				"React Router",
			...
			milestones: [
				"Build a typed e-commerce product page",
				"Implement a custom hook library",
				"Set up React Router with auth guards",
			],
			resources: [
				{ label: "React Official Docs", url: "https://react.dev" },
				{
					label: "Total TypeScript – Free Tutorials",
					url: "https://www.totaltypescript.com",
				},
				{
					label: "Epic React (Kent C. Dodds)",
		...
		{
			id: "phase-4",
			label: "Modern Tooling & Testing",
			duration: "3 weeks",
			description:
				"Learn build tools, testing frameworks, and developer workflows.",
			skills: [
				"Vite",
				"Vitest",
			...
			milestones: [
				"Set up a full CI pipeline with tests",
				"Achieve 80%+ test coverage on a project",
				"Configure lint-staged and commit hooks",
			],
			resources: [
				...
				{
					label: "ESLint Configuration Guide",
					url: "https://eslint.org/docs/latest/user-guide/configuring/",
				},
				{ label: "Prettier Docs", url: "https://prettier.io/docs/en/" },
				{ label: "Biome.js Docs", url: "https://biomejs.dev/" },
				{
					label: "kentcdodds – Testing Fundamentals",
		...
		},
		{
			...
			duration: "2 weeks",
			description: "Make apps fast, accessible, and production-ready.",
			skills: [
				"Core Web Vitals",
				"WCAG 2.1",
				"Lighthouse",
			...
			resources: [
				...
				{
					label: "Chrome DevTools – Lighthouse",
					url: "https://developer.chrome.com/docs/lighthouse/overview/",
				},
				{
					label: "React Code Splitting Guide",
				...
				{
					label: "Patterns for Performant CSS",
					url: "https://web.dev/patterns/",
				},
				{
					label: "Accessibility Insights Chrome Extension",
					url: "https://accessibilityinsights.io/docs/web/overview/",
				},
				{
					label: "Smashing Magazine – Performance",
					url: "https://www.smashingmagazine.com/tag/performance/",
				},
			],
		},
		{
			...
			duration: "2 weeks",
			description: "Ship real projects and build a compelling portfolio.",
			skills: [
				"Project Planning",
				"Vercel/Netlify",
				"README Writing",
			...
			milestones: [
				"Deploy 2 full-stack projects",
				"Write detailed case studies for each",
				"Optimize GitHub profile with pinned repos",
			],
			resources: [
				...
				{
					label: "Awesome GitHub Profile README",
				...
				{
					label: "Product Hunt – Launch Projects",
	...
	"Backend Engineer": [
		{
			...
			duration: "3 weeks",
			description:
				"Build a strong foundation in a backend language with clean coding practices.",
			skills: [
				"Python or Node.js",
				"OOP & Design Patterns",
				"File I/O",
			...
			milestones: [
				"Build a CLI tool with clean architecture",
				"Write unit tests achieving 80%+ coverage",
				"Implement a REST client from scratch",
			],
			resources: [
				{ label: "Node.js Official Docs", url: "https://nodejs.org/en/docs/" },
				{
					label: "Real Python – OOP Guide",
					url: "https://realpython.com/python3-object-oriented-programming/",
				},
				{
				...
				{
					label: "Python Type Hints Guide",
					url: "https://docs.python.org/3/library/typing.html",
				},
				{
					label: "Clean Code in JS/TS",
		...
		},
		{
			...
			duration: "3 weeks",
			description:
				"Master relational and NoSQL databases with efficient query design.",
			skills: [
				"PostgreSQL",
				"SQL Queries",
				"Indexing",
			...
			milestones: [
				"Design a normalized database schema for an e-commerce app",
		...
		},
		{
			...
			duration: "3 weeks",
			description:
				"Build robust, well-documented APIs following industry standards.",
			skills: [
			...
			milestones: [
				"Build a CRUD API with Express + Zod validation",
			...
			resources: [
				...
				{
					label: "GraphQL Official Tutorials",
				...
				{
					label: "tRPC – End-to-end Typesafe APIs",
					url: "https://trpc.io/docs",
				},
				{
					label: "Postman – API Design",
		...
		},
		{
			...
			milestones: [
				...
				"Add role-based access control to an API",
			],
			resources: [
				{
					label: "Auth0 – JWT Handbook",
					url: "https://auth0.com/resources/ebooks/jwt-handbook",
				},
				{
					label: "OWASP – Web Security Top 10",
				...
				{
					label: "Helmet.js – Secure Headers",
					url: "https://helmetjs.github.io/",
				},
				{
					label: "Rate Limiting with express-rate-limit",
					url: "https://www.npmjs.com/package/express-rate-limit",
				},
				{
					label: "CORS Guide by MDN",
					url: "https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS",
				},
				{
					label: "Node.js Security Checklist",
					url: "https://blog.risingstack.com/node-js-security-checklist/",
				},
				{
					label: "Passport.js Auth Strategies",
		...
		{
			id: "phase-5",
			label: "Caching, Queues & Scaling",
			duration: "3 weeks",
			description:
				"Scale your backend with caching, background jobs, and load balancing.",
			skills: [
				"Redis",
				"BullMQ / Celery",
				"Horizontal Scaling",
			...
			milestones: [
				"Add Redis caching to reduce DB load by 50%",
			...
			resources: [
				...
				{
					label: "Celery – Distributed Task Queue",
				...
				{
					label: "AWS Elastic Beanstalk Docs",
					url: "https://docs.aws.amazon.com/elastic-beanstalk/",
				},
				{
					label: "Docker Compose for Backend",
					url: "https://docs.docker.com/compose/",
				},
				{
					label: "Varnish Cache Guide",
					url: "https://varnish-cache.org/docs/",
				},
				{
					label: "Cloudflare CDN Docs",
					url: "https://developers.cloudflare.com/cdn/",
				},
				{
					label: "System Design Primer – Scalability",
		...
		},
		{
			...
			duration: "2 weeks",
			description:
				"Ship your backend with automated deployments, monitoring, and alerting.",
			skills: [
				"Docker",
				"GitHub Actions",
				"PM2 or Supervisor",
			...
			milestones: [
				"Containerize a backend with Docker",
				"Set up a GitHub Actions deploy pipeline",
				"Configure structured logging and uptime monitoring",
			],
			resources: [
				...
				{
					label: "PM2 – Node.js Process Manager",
					url: "https://pm2.keymetrics.io/docs/usage/quick-start/",
				},
				{
					label: "Winston – Logging Library",
	...
	"Full-Stack Developer": [
		{
			...
			duration: "3 weeks",
			description:
				"Master HTML, CSS, JavaScript and responsive design principles.",
			skills: [
				"Semantic HTML5",
				"CSS Grid & Flexbox",
				"JavaScript ES6+",
			...
			milestones: [
				"Build a responsive multi-page website from scratch",
				"Implement interactive UI features with vanilla JS",
				"Create a CSS animation library",
			],
			resources: [
				{
					label: "MDN Web Docs – HTML & CSS",
					url: "https://developer.mozilla.org/en-US/docs/Learn",
				},
				{
					label: "javascript.info – Modern JS",
				...
				{
					label: "FreeCodeCamp – Responsive Design",
		...
		},
		{
			...
			duration: "4 weeks",
			description:
				"Build component-driven SPAs with TypeScript and modern React patterns.",
			skills: [
				"React (Hooks)",
				"TypeScript",
				"React Router",
			...
			milestones: [
				"Build a full-stack task manager app",
				"Convert a JS codebase to TypeScript",
		...
		},
		{
			...
			duration: "3 weeks",
			description:
				"Build RESTful APIs with Express and connect to PostgreSQL databases.",
			skills: [
				"Node.js / Express",
				"RESTful Design",
				"PostgreSQL",
			...
			milestones: [
				"Build a CRUD API with Express + Prisma",
				"Design and migrate a relational schema",
				"Add input validation with Zod",
			],
			resources: [
				{
					label: "Express.js Routing Guide",
					url: "https://expressjs.com/en/guide/routing.html",
				},
				{ label: "Prisma ORM Docs", url: "https://www.prisma.io/docs" },
				{
		...
		{
			id: "phase-4",
			label: "Authentication & Full-Stack Integration",
			duration: "3 weeks",
			description:
				"Connect frontend to backend with auth, sessions, and secure data flow.",
			skills: [
				"JWT Auth",
				"OAuth2",
				"CORS",
			...
			milestones: [
				"Add JWT login/signup to your full-stack app",
				"Connect React frontend to Express backend",
				"Deploy both frontend and backend to production",
			],
			resources: [
				{
					label: "JWT.io – JSON Web Tokens",
					url: "https://jwt.io/introduction",
				},
				{ label: "Better Auth Docs", url: "https://www.better-auth.com/docs" },
				{
					label: "Auth0 – Full-Stack Auth Guide",
				...
				{
					label: "tRPC for Full-Stack Typesafety",
					url: "https://trpc.io/docs",
				},
		...
		},
		{
			...
			duration: "3 weeks",
			description:
				"Automate testing, CI/CD, and deployments for your full-stack apps.",
			skills: [
				"Docker",
				"GitHub Actions",
				"E2E Testing",
			...
			milestones: [
				"Set up CI pipeline with tests on every push",
				"Write E2E tests with Playwright",
				"Containerize full-stack app with Docker Compose",
			],
			resources: [
				{ label: "Docker Official Docs", url: "https://docs.docker.com/" },
				{
		...
		{
			id: "phase-6",
			label: "Portfolio & Production Polish",
			duration: "2 weeks",
			description:
				"Ship production-ready features: monitoring, SEO, performance, and a killer portfolio.",
			skills: [
			...
			milestones: [
				"Achieve 90+ Lighthouse on both frontend and API",
				"Write comprehensive README and API docs",
				"Present your full-stack project with a live demo",
			],
			resources: [
				{
					label: "web.dev – Performance",
	...
	"DevOps / Platform Engineer": [
		{
			...
			duration: "3 weeks",
			description:
				"Master Linux administration, shell scripting, and command-line productivity.",
			skills: [
				"Bash Scripting",
				"Linux File System",
				"Process Management",
			...
			milestones: [
				"Write an automation script for system backups",
				"Set up a Linux server from scratch with hardened security",
				"Create a CLI tool in bash",
			],
			resources: [
				{
					label: "Linux Journey – Interactive Tutorial",
					url: "https://linuxjourney.com/",
				},
				{
					label: "Bash Scripting Guide (TLDP)",
					url: "https://tldp.org/LDP/abs/html/",
				},
				{
					label: "Linux Command Line Basics (DigitalOcean)",
					url: "https://www.digitalocean.com/community/tutorials/linux-commands",
				},
				{
					label: "SSH Essentials Guide",
				...
				{
					label: "Networking Basics for DevOps",
		...
		},
		{
			...
			duration: "3 weeks",
			description:
				"Containerize applications, manage images, and orchestrate multi-service setups.",
			skills: [
				"Dockerfile",
				"Docker Compose",
				"Image Optimization",
			...
			milestones: [
				...
				"Optimize a Docker image from 1GB to <200MB",
			...
			resources: [
				...
				{
					label: "Play with Docker Lab",
					url: "https://labs.play-with-docker.com/",
				},
				{
					label: "Docker Best Practices Guide",
				...
				{
					label: "Docker Hub – Image Registry",
					url: "https://hub.docker.com/",
				},
				{
					label: "Docker Networking Guide",
					url: "https://docs.docker.com/network/",
				},
				{
					label: "Docker Volumes Explained",
					url: "https://docs.docker.com/storage/volumes/",
				},
				{
					label: "Awesome Docker Compose Examples",
		...
		},
		{
			...
			duration: "3 weeks",
			description:
				"Automate build, test, and deployment pipelines for reliable software delivery.",
			skills: [
				"GitHub Actions",
				"Jenkins Basics",
				"Pipeline as Code",
			...
			milestones: [
				"Build a CI pipeline that runs tests and lints",
				"Create a CD pipeline deploying to staging on merge",
		...
		},
		{
			...
			duration: "4 weeks",
			description:
				"Orchestrate containers at scale with Kubernetes for production-grade deployments.",
			skills: [
			...
			milestones: [
				"Deploy a microservice app on Minikube",
				"Write a Helm chart for your app",
			...
			resources: [
				...
				{
					label: "Kubernetes Networking Guide",
				...
				{
					label: "Kubernetes Best Practices Book",
					url: "https://www.oreilly.com/library/view/kubernetes-best-practices/9781492056461/",
				},
			],
		},
		{
			...
			duration: "3 weeks",
			description:
				"Implement logging, metrics, tracing, and alerting for production systems.",
			skills: [
				"Prometheus",
				"Grafana",
				"ELK Stack",
			...
			milestones: [
				...
				"Create dashboards for CPU, memory, and request latency",
			...
			resources: [
				...
				{
					label: "Grafana Dashboards Guide",
				...
				{
					label: "Datadog – Monitoring Docs",
					url: "https://docs.datadoghq.com/",
				},
				{
					label: "New Relic – APM Guide",
				...
				{
					label: "Alertmanager Guide",
					url: "https://prometheus.io/docs/alerting/latest/alertmanager/",
				},
				{ label: "Sentry – Error Tracking", url: "https://docs.sentry.io/" },
				{
					label: "Uptime Kuma – Self-Hosted Monitoring",
		...
		},
		{
			...
			duration: "4 weeks",
			description:
				"Provision and manage cloud infrastructure using Terraform and cloud provider services.",
			skills: [
				"AWS / GCP Basics",
				"Terraform",
				"Ansible Basics",
			...
			milestones: [
				"Provision a VPC + EC2 instance with Terraform",
				"Set up a load-balanced auto-scaling group",
			...
			resources: [
				...
				{
					label: "AWS Certified Cloud Practitioner Guide",
				...
				{
					label: "Cloudflare – DNS & CDN Docs",
					url: "https://developers.cloudflare.com/",
				},
				{
					label: "Nginx Configuration Guide",
					url: "https://nginx.org/en/docs/",
				},
				{
					label: "System Design – The Primer",
					url: "https://github.com/donnemartin/system-design-primer",
				},
			],
		},
	...
	"Data Engineer": [
		{
			id: "phase-1",
			label: "Python & SQL Foundations",
			duration: "3 weeks",
			description:
				"Build a strong foundation in Python for data processing and SQL for querying.",
			skills: [
				"Python (pandas, numpy)",
				"Advanced SQL",
				"Data Cleaning",
			...
			milestones: [
				"Clean and analyze a real-world dataset with pandas",
				"Write complex SQL queries with CTEs and window functions",
				"Build a reusable data processing pipeline in Python",
			],
			resources: [
				{
				...
				{
					label: "Kaggle – Python for Data Science",
					url: "https://www.kaggle.com/learn/python",
				},
				{
				...
				{
					label: "Real Python – Pandas Guide",
					url: "https://realpython.com/pandas-python-explore-dataset/",
				},
				{
					label: "DataCamp – Data Engineer Track",
					url: "https://www.datacamp.com/tracks/data-engineer-with-python",
				},
				{
					label: "SQL Bolt – Interactive Lessons",
					url: "https://sqlbolt.com/",
				},
				{
					label: "Python Data Cleaning Cookbook",
					url: "https://www.oreilly.com/library/view/python-data-cleaning/9781492056997/",
				},
			],
		},
		{
			...
			duration: "3 weeks",
			description:
				"Design dimensional models and manage data warehouses for analytics.",
			skills: [
			...
			milestones: [
				"Design a star schema for an e-commerce data warehouse",
				"Build a dbt transformation pipeline",
				"Write optimized queries in BigQuery",
			],
			resources: [
				{ label: "dbt Docs", url: "https://docs.getdbt.com/" },
				{
					label: "Google BigQuery Docs",
					url: "https://cloud.google.com/bigquery/docs",
				},
				{ label: "Snowflake Docs", url: "https://docs.snowflake.com/en/" },
				{
					label: "Kimball – Dimensional Modeling",
					url: "https://www.kimballgroup.com/data-warehouse-bus-archive/",
				},
				{
					label: "DataBuildTool – dbt Learn",
					url: "https://courses.getdbt.com/",
				},
				{
					label: "Redshift – AWS Docs",
					url: "https://docs.aws.amazon.com/redshift/",
				},
				{
					label: "Airbyte – Data Integration",
					url: "https://docs.airbyte.com/",
				},
				{ label: "Fivetran Docs", url: "https://fivetran.com/docs" },
				{
					label: "Data Warehouse Toolkit Book",
					url: "https://www.oreilly.com/library/view/the-data-warehouse/9781119629264/",
				},
				{
					label: "Star Schema vs Snowflake",
					url: "https://www.databricks.com/glossary/star-schema",
				},
			],
		},
		{
			id: "phase-3",
			label: "ETL/ELT Pipelines & Workflow Orchestration",
			duration: "4 weeks",
			description:
				"Build robust data pipelines with workflow orchestration and scheduling.",
			skills: [
				"Apache Airflow",
				"Prefect",
				"Python ETL",
			...
			milestones: [
				...
				"Set up data quality monitoring checks",
			],
			resources: [
				{
					label: "Apache Airflow Docs",
					url: "https://airflow.apache.org/docs/",
				},
				{ label: "Prefect Docs", url: "https://docs.prefect.io/" },
				{
					label: "Astronomer – Airflow Tutorials",
				...
				{
					label: "Apache Spark – ETL Guide",
					url: "https://spark.apache.org/docs/latest/sql-programming-guide.html",
				},
				{
					label: "Kestra – Workflow Orchestration",
					url: "https://kestra.io/docs",
				},
				{
					label: "Data Engineering Cookbook",
					url: "https://github.com/andkret/Cookbook",
				},
				{
					label: "Towards Data Science – ETL Articles",
					url: "https://towardsdatascience.com/tagged/etl",
				},
				{
					label: "Meltano – Open Source ELT",
		...
		},
		{
			...
			duration: "4 weeks",
			description:
				"Process large-scale datasets with distributed computing and real-time streaming.",
			skills: [
				"Apache Spark",
				"Kafka Basics",
				"Parquet/AVRO",
			...
			milestones: [
				"Process a 10GB+ dataset with PySpark",
				"Build a Kafka producer-consumer pipeline",
				"Convert batch jobs to streaming with Kafka Streams",
			],
			resources: [
				{
				...
				{
					label: "Confluent – Kafka Learn",
					url: "https://developer.confluent.io/",
				},
				{
					label: "Apache Flink Docs",
					url: "https://nightlies.apache.org/flink/flink-docs-stable/",
				},
				{
					label: "Parquet Format Docs",
					url: "https://parquet.apache.org/docs/",
				},
				{
					label: "Databricks – Spark Notebooks",
					url: "https://www.databricks.com/learning",
				},
				{
					label: "Data Streaming Explained",
					url: "https://www.oreilly.com/library/view/streaming-systems/9781491983865/",
				},
				{
					label: "Amazon Kinesis Docs",
					url: "https://docs.aws.amazon.com/kinesis/",
				},
				{
					label: "Kafka the Definitive Guide (Book)",
		...
		},
		{
			...
			duration: "3 weeks",
			description:
				"Leverage cloud-native data services for scalable and cost-effective data engineering.",
			skills: [
				"AWS S3 & Glue",
				"GCP Dataflow",
				"Azure Data Factory",
			...
			milestones: [
				"Set up a data lake on S3 with Glue catalog",
				"Build a serverless ETL pipeline with Dataflow",
				"Provision data infrastructure with Terraform",
			],
			resources: [
				{ label: "AWS Glue Docs", url: "https://docs.aws.amazon.com/glue/" },
				{
					label: "Google Dataflow Docs",
					url: "https://cloud.google.com/dataflow/docs",
				},
				{
					label: "Azure Data Factory Docs",
					url: "https://learn.microsoft.com/en-us/azure/data-factory/",
				},
				{
					label: "Terraform for Data Infrastructure",
					url: "https://developer.hashicorp.com/terraform/tutorials",
				},
				{ label: "AWS S3 Docs", url: "https://docs.aws.amazon.com/s3/" },
				{
					label: "GCP Cloud Storage Docs",
					url: "https://cloud.google.com/storage/docs",
				},
				{
					label: "Delta Lake Docs",
				...
				{
					label: "Data Lake vs Warehouse Guide",
					url: "https://www.databricks.com/glossary/data-lake",
				},
				{
					label: "dbt + Snowflake Quickstart",
					url: "https://quickstarts.snowflake.com/guide/dbt/",
				},
			],
		},
		{
			id: "phase-6",
			label: "Data Governance & Production",
			duration: "3 weeks",
			description:
				"Implement data cataloging, lineage, and production monitoring for reliable pipelines.",
			skills: [
				"Data Cataloging",
				"Data Lineage",
				"SLA Monitoring",
			...
			milestones: [
				"Set up data lineage tracking with OpenLineage",
				"Create SLA dashboards for pipeline health",
				"Write a production incident runbook",
			],
			resources: [
				...
				{
					label: "Amundsen – Data Discovery",
					url: "https://www.amundsen.io/amundsen/",
				},
				{
					label: "DataHub – Metadata Platform",
					url: "https://datahubproject.io/docs/",
				},
				{
					label: "Monte Carlo – Data Observability",
					url: "https://www.montecarlodata.com/learn/",
				},
				{
					label: "Soda – Data Quality Monitoring",
					url: "https://docs.soda.io/",
				},
				{
					label: "dbt – Documentation & Lineage",
					url: "https://docs.getdbt.com/docs/build/documentation",
				},
				{
					label: "Great Expectations – Data Validation",
					url: "https://docs.greatexpectations.io/",
				},
				{
					label: "Data Engineering Best Practices",
					url: "https://github.com/datastacktv/data-engineer-roadmap",
				},
				{
					label: "GDPR Compliance for Data Engineers",
...
function buildStructuredPhases(goal: string): RoadmapPhase[] {
	const template =
		STRUCTURED_ROADMAPS[goal] || STRUCTURED_ROADMAPS["Frontend Engineer"];
	...
	try {
		...
		return data.map((p: Record<string, unknown>, i: number) => ({
			...
			resources: Array.isArray(p.resources)
				? p.resources.map((r: Record<string, string>) => ({
		...
		throw new AppError(
			"AI returned an invalid roadmap format. Please try again.",
			500,
		);
	}
}
